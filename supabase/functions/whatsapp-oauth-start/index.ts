...
serve(async (req) => {
  ...
  try {
    ...
    // WhatsApp OAuth URL - using Facebook OAuth for WhatsApp Business API
    ...
    console.log('WhatsApp OAuth Start - Clinic:', clinicId, 'Location:', locationId);
    ...
    console.error('Error in whatsapp-oauth-start:', error);
